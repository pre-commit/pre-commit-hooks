...
# 3.6.0
    ...
    class Deque(
        collections.deque, typing.MutableSequence[T],
...
# 3.6
    ...
    class OrderedDict(
        collections.OrderedDict, typing.MutableMapping[KT, VT],
        metaclass=_ExtensionsGenericMeta,
...
if hasattr(typing, 'ChainMap'):
    ...
    class ChainMap(
        collections.ChainMap, typing.MutableMapping[KT, VT],
        metaclass=_ExtensionsGenericMeta,
...
# 3.6.0
    ...
    class AsyncGenerator(
        AsyncIterator[T_co], typing.Generic[T_co, T_contra],
        metaclass=_ExtensionsGenericMeta,
...
def _get_protocol_attrs(cls):
    ...
    for base in cls.__mro__[:-1]:  # without object
        ...
        for attr in list(base.__dict__.keys()) + list(annotations.keys()):
            if (
                not attr.startswith('_abc_') and attr not in (
...
# 3.7
    ...
    class _ProtocolMeta(abc.ABCMeta):
        ...
        def __instancecheck__(cls, instance):
            ...
            if ((
                not getattr(cls, '_is_protocol', False) or
        ...
        def __init_subclass__(cls, *args, **kwargs):
            ...
            if '__orig_bases__' in cls.__dict__:
                ...
                for base in cls.__orig_bases__:
                    if (
                        isinstance(base, typing._GenericAlias) and
            ...
            def _proto_hook(other):
                ...
                for attr in _get_protocol_attrs(cls):
                    for base in other.__mro__:
                        ...
                        annotations = getattr(base, '__annotations__', {})
                        if (
                            isinstance(annotations, typing.Mapping) and
            ...
            for base in cls.__bases__:
                if not (
                    base in (object, typing.Generic) or
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __new__(
            ...
            initial_bases = bases
            if (
                extra is not None and type(extra) is abc.ABCMeta and
                extra not in bases
            ):
                bases = (extra,) + bases
            bases = tuple(
            ...
            self.__args__ = tuple(
                ... if a is typing._TypingEllipsis else
            ...
            if hasattr(self, '_subs_tree'):
                self.__tree_hash__ = (
                    hash(self._subs_tree()) if origin else
        ...
        def __instancecheck__(self, instance):
            ...
            # assigned in __init__.
            if ((
                not getattr(self, '_is_protocol', False) or
                _is_callable_members_only(self)
            ) and
        ...
        def __subclasscheck__(self, cls):
            if self.__origin__ is not None:
                ...
                return False
            if (
                self.__dict__.get('_is_protocol', None) and
            ...
            if (
                self.__dict__.get('_is_runtime_protocol', None) and
...
# 3.7-3.9
    ...
    def get_origin(tp):
        ...
        if isinstance(
            tp, (
                typing._GenericAlias, GenericAlias, _BaseGenericAlias,
