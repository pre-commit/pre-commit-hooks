...
def is_expandable(obj: Any) -> bool:
    ...
    return (
        isinstance(obj, _CONTAINERS) or
        (is_dataclass(obj)) or
        (hasattr(obj, '__rich_repr__')) or
        _is_attr_object(obj)
    ) and not isclass(obj)
...
def traverse(
    ...
    def to_repr(obj: Any) -> str:
        ...
        if (
            max_string is not None and
            isinstance(obj, (bytes, str)) and
            len(obj) > max_string
        ):
    ...
    def _traverse(obj: Any, root: bool = False, depth: int = 0) -> Node:
        ...
        if rich_repr_result is not None:
            ...
            not fake_attributes and
            (_is_dataclass_repr(obj) or py_version == (3, 6))
        ):
            obj_id = id(obj)
