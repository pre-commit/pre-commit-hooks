...
def copystat(src, dst):
    ...
    if hasattr(os, 'chflags') and hasattr(st, 'st_flags'):
        try:
            ...
            if (
                not hasattr(errno, 'EOPNOTSUPP') or
    ...
    try:
        ...
        if os.path.isdir(src):
            if _destinsrc(src, dst):
                raise Error("Cannot move a directory '{}' into itself '{}'.".format(src, dst))
...
def get_archive_formats():
    ...
    """
    formats = [
        (name, registry[2]) for name, registry in
...
def get_unpack_formats():
    ...
    """
    formats = [
        (name, info[0], info[3]) for name, info in
