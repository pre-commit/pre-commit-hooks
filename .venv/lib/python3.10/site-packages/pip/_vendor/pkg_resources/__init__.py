...
class WorkingSet:
    ...
    def resolve(
        self, requirements, env=None, installer=None,
...
def get_default_cache():
    ...
    return (
        ...
        platformdirs.user_cache_dir(appname='Python-Eggs')
    )
...
def safe_listdir(path):
    ...
    try:
        ...
        # permission denied
        ignorable = (
            e.errno in (errno.ENOTDIR, errno.EACCES, errno.ENOENT) or
            # Python 2 on Windows needs to be handled this way :(
            getattr(e, 'winerror', None) == 267
        )
        if not ignorable:
            raise
    return ()
