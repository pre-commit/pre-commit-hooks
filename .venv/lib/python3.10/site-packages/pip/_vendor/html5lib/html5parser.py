...
class HTMLParser:
    ...
    def __init__(self, tree=None, strict=False, namespaceHTMLElements=True, debug=False):
        ...
        self.phases = {
            name: cls(self, self.tree) for name, cls in
    ...
    def isHTMLIntegrationPoint(self, element):
        if (
            element.name == 'annotation-xml' and
    ...
    def mainLoop(self):
        ...
        for token in self.tokenizer:
                    ...
                    if (
                        ...
                        (
                            ...
                            ((
                                ...
                                token['name'] not in frozenset(['mglyph', 'malignmark'])
                            ) or
                                type in (CharactersToken, SpaceCharactersToken))
                        ) or
                        (
            ...
            if (
                type == StartTagToken and prev_token['selfClosing'] and
...
def getPhases(debug):
    ...
    class InitialPhase(Phase):
        ...
        def processDoctype(self, token):
            ...
            if (
                name != 'html' or publicId is not None or
            ...
            if (
                not correct or token['name'] != 'html' or
                publicId.startswith(
                    (
    ...
    class InBodyPhase(Phase):
        ...
        def startTagBody(self, token):
            ...
            if (
                len(self.tree.openElements) == 1 or
        ...
        def startTagListItem(self, token):
            ...
            for node in reversed(self.tree.openElements):
                if node.name in stopNames:
                    ...
                    break
                if (
                    node.nameTuple in specialElements and
    ...
    class InTableBodyPhase(Phase):
        ...
        def startTagTableOther(self, token):
            ...
            if (
                self.tree.elementInScope('tbody', variant='table') or
    ...
    class InCellPhase(Phase):
        ...
        def startTagTableOther(self, token):
            if (
                self.tree.elementInScope('td', variant='table') or
    ...
    class InSelectPhase(Phase):
        ...
        def endTagOptgroup(self, token):
            ...
            if (
                self.tree.openElements[-1].name == 'option' and
    ...
    class InForeignContentPhase(Phase):
        ...
        def processStartTag(self, token):
            ...
            if (
                token['name'] in self.breakoutElements or
                (
                    token['name'] == 'font' and
...
def impliedTagToken(
    name, type='EndTag', attributes=None,
    selfClosing=False,
):
    if attributes is None:
        attributes = {}
    return {
        'type': tokenTypes[type], 'name': name, 'data': attributes,
